...
\begin{example}[诊断)]
    ...
    \begin{center}
        ...
        \item 3) $r_{BornInProvince} \circ r_{ProvinceInCountry} \sqsubseteq r_{Nationality}$
		\item 4) $r_{BornInCity} (Mike, Guangzhou)$
        \item 5) $r_{CityInProvince} (Guangzhou, Guangdong)$
		\item 6) $r_{ProvinceInCountry} (Guangdong, China)$
    \end{center}
	
	训练集：
    \begin{center}
        \item 1) $(Lily, \emph{BornInCity}, Hangzhou)$
        \item 2) $Beihai, \emph{CityInProvince}, Guangxi)$
		\item 3) $(Guangxi, \emph{ProvinceInCountry}, China)$
    \end{center}
